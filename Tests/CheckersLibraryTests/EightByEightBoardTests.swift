...
class EightByEightBoardTests: XCTestCase {
    ...
    func testMove() {
        ...
        XCTAssertEqual(
            EightByEightBoard(blackMen: 1420448768, blackKings: 0, whiteMen: 6172839697753047040, whiteKings: 0)
                .move(.BlackMen, Direction(.Up(1), .Left(1))),
            EightByEightBoard(blackMen: 2774314, blackKings: 0, whiteMen: 6172839697753047040, whiteKings: 0))
        XCTAssertEqual(
            EightByEightBoard(blackMen: 131072, blackKings: 67108864, whiteMen: 2097152, whiteKings: 268435456)
                .move(.BlackKings, Direction(.Up(1), .Right(1))),
            EightByEightBoard(blackMen: 131072, blackKings: 524288, whiteMen: 2097152, whiteKings: 268435456))
        XCTAssertEqual(
            EightByEightBoard(blackMen: 131072, blackKings: 67108864, whiteMen: 2097152, whiteKings: 268435456)
                .move(.BlackKings, Direction(.Up(2), .Right(2))),
            EightByEightBoard(blackMen: 131072, blackKings: 4096, whiteMen: 2097152, whiteKings: 268435456))
        XCTAssertEqual(
            EightByEightBoard(
                blackMen: 36033238015283464,
                blackKings: 32,
                whiteMen: 1152922604126863360,
                whiteKings: 360305562663518208)
                .move(.At([8, 21]), Direction(.Up(1), .Right(1))),
            EightByEightBoard(
                blackMen: 36033238015283210,
                blackKings: 32,
                whiteMen: 1152922604126863360,
                whiteKings: 360305562661437440))
    }
}
